...
{{-- <div class="row justify-content-center">
    <div class="col-lg-6 card p-3">
        ...
        <main class="form-signin w-100 m-auto">
            <img class="mb-4 rounded mx-auto d-block invert dark:invert-0" src="/img/logo.png" alt="" width="72" height="57">
            ...
            <form action="/login" method="post">
                ...
                <div class="form-floating">
                    ...
                    is-invalid
                    @enderror" name="email" id="email" placeholder="name@example.com" autofocus required required value="{{ old('email') }}">
