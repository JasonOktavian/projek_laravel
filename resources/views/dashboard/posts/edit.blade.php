...
<h1 class="text-xl font-bold text-center mb-3">Edit Post</h1>
    ...
    <form method="POST" action="/dashboard/posts" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            <div class="relative z-0 w-full mb-6 group">
                <input type="text" class="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:text-white dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer @error('title') is-invalid
        ...
        <button type="submit" class="bg-green-500 px-3 py-2 rounded-md mb-5">Update Post</button>
</form>
</div>
<div class="bg-white rounded-md">
    ...
    <div class="justify-center items-center flex h-screen w-full">
        @if ($post->image)
        <img src="{{ asset('storage/'. $post->image) }}" class="img-preview w-3/4 rounded-md">
        @else
